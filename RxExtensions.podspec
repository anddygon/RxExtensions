...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/snmgxp@126.com/RxExtensions'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'snmgxp@126.com' => 'anddygong@gmail.com' }
  s.source           = { :git => 'https://github.com/snmgxp@126.com/RxExtensions.git', :tag => s.version.to_s }
